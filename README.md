...
- Previosuly I have been a part of two successsful startups: 1. Hyliion and 2. ParallelChain Lab. At ParallelChain Lab, I contributed to building the WebAssembly stack for its [runtime](https://github.com/parallelchain-io/pchain-runtime/tree/main/src/wasmer), [networking layer](https://github.com/parallelchain-io/pchain-network) and its [indexer](https://explorer.parallelchain.io/explorer?network=Mainnet). 
